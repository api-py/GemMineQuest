...
struct ShopItem: Identifiable {
    ...
    static let catalog: [ShopItem] = [
        ShopItem(id: "pickaxe_3", boosterType: .pickaxe, quantity: 3, price: 1000, displayName: "Pickaxe x3", iconName: "hammer.fill"),
        ShopItem(id: "pickaxe_10", boosterType: .pickaxe, quantity: 10, price: 2800, displayName: "Pickaxe x10", iconName: "hammer.fill"),
        ShopItem(id: "dynamite_1", boosterType: .dynamite, quantity: 1, price: 1500, displayName: "Dynamite", iconName: "flame.fill"),
        ShopItem(id: "dynamite_5", boosterType: .dynamite, quantity: 5, price: 6000, displayName: "Dynamite x5", iconName: "flame.fill"),
        ShopItem(id: "drone_1", boosterType: .droneStrike, quantity: 1, price: 2000, displayName: "Drone Strike", iconName: "scope"),
